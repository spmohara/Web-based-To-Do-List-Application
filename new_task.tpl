<html>
    ...
    <body style="background-color:FCF0AD;">
        <p style="padding-top:20px; padding-bottom:10px; font-size:80px;">New Task</p>
        <form action="/todo/new" method="GET">
                <input type="text" name="task" size="" maxlength="75" style="font-size:30px; height:50px;">
                <input type="text" name="date" size="5" maxlength="5" style="font-size:30px; height:50px;">
                <br>
                <br>
